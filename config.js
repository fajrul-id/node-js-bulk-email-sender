...
exports.send = {
	...
	SMTP : {
		...
		Port 	  : 587, // Smtp port
		Hostname  : "smtp.office365.com", // Set local hostname ( Levae it blank if not using )
	},

	LIST : {
		File 	  : "List/list.txt", // List file
		RemoveDup : false, // Remove list duplicate ( true/false )
		Logfailed : true // Log failed send ( Stored in Log/failed.txt )
	},
	...
	ATTACHMENT : {
		...
		Name 	  : "case##number_9##_##number_6##.txt", // Attachment custom name
	...
	SEND : {
		Delay 	  : 500, // Sending delay for x miliseconds
		Priority  : "high", // Email priority ( high/normal/low ) ( Levae it blank if not using )
		...
		Fromname  : " Apple ", // From name ( Levae it blank if not using )
		Frommail  : "", // From mail ( Levae it blank if not using )
		Subject   : "We've sent a notification that your Apple ID was last locked", // Subject ( Levae it blank if not using )
